...
class Header extends React.Component {
    render() {
        return (
            <div>
                <div style={{position:'relative',height:'200px',backgroundColor:"#dcdcdc",borderRadius:'20px',margin:'20px auto',textAlign:'center',}} alt="react-boilerplate - Logo">
                    <div style={{position:'absolute',top:70,width:'auto',fontSize:33,left:50}}>Repeat Example for Working Hour Plugin</div>
                </div>
            </div>
        );
    }
